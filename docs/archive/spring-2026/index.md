...
This section archives the AI course as it ran in the **Spring 2026** semester.

!!! info "Placeholder content"
    This overview is a placeholder. Replace it with a short summary of the
    semester once the details are finalized: instructors, general theme or
    focus, notable changes from prior semesters, and any other high-level
    context worth recording for posterity.
...
from any other semester in the archive.
